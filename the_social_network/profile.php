...
<div class="row">
	...
	<div class="col-sm-8">
		<?php
			echo"
			<div>
				<div><img id='cover-img' class='img-rounded' src='cover/$user_cover' alt='cover'  onerror=this.src='cover/cover.jpg'>></div>
				...
				<ul class='nav pull-left' style='position:absolute;top:10px;left:40px;'>
					<li class='dropdown'>
						...
						<div class='dropdown-menu'>
							...
							<label id='select_cover_btn' class='btn btn-info'> Select Cover
							<input type='file' name='u_cover' size='60' />
							</label><br><br>
							<button id='update_cover_btn' name='submit' class='btn btn-info'>Update Cover</button>
							</center>
						</div>
					</li>
				</ul>
			...
			<div id='profile-img'>
				...
				onerror=this.src='users/user.jpg'>
				<form action='profile.php?u_id='$user_id' method='post' enctype='multipart/form-data'>
