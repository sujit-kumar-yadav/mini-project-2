...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="home.php">the_social_network</a>
		</div>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					<form class="navbar-form navbar-left" method="get" action="results.php">
						...
						<button type="submit" class="btn btn-info" name="search" style="background-color: #c4302b; border: 1px solid #c4302b">Search</button>
					</form>
				</li>
			</ul>
		</div>
